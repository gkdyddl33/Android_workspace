...
import com.koreait.pageapp.fragement.RedFragement;
import com.koreait.pageapp.fragement.YellowFragement;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments[0] = new RedFragement(); //화면 조각 생성!!!
        fragments[1] = new BlueFragment(); //화면 조각 생성!!!
        fragments[2] = new YellowFragement(); //화면 조각 생성!!!
